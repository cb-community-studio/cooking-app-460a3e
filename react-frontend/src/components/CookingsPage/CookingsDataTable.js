...
const CookingsDataTable = ({ items, onEditRow, onRowDelete, onRowClick }) => {
    ...
    return (
        <DataTable value={items} onRowClick={onRowClick} scrollable rowHover paginator rows={10}>
            ...
            <Column field="methods" header="Methods" body={pTemplate3} style={{ minWidth: "8rem" }} />
...
export default CookingsDataTable;